...
#' Release Notes: \tab Added features needed for RPP for interop from/to R. Enhanced some of the C API. \cr
#' License: \tab LGPL-3 \cr
#' }
#'
#' \tabular{lll}{
#' Version \tab Date \tab Notes \cr
#' 0.3.1 \tab 2017-07-21 Added features needed for RPP. Enhanced some of the C API. \cr
#' 0.2.2 \tab 2017-06-22 Minor functions added. Note that the R package itself (i.e. not the C++ library) is still new and much documentation remains to be written/ported from other packages. \cr
