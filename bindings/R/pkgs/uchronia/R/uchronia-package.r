...
#' Release Notes: \tab Changes to the error handling of the C API, to reliably catch C std exceptions and surface via python \cr
#' License: \tab BSD-3 \cr
#' }
#'
#' \tabular{lll}{
...
#' 2.3.4 \tab 2020-12-08 \tab Cumulative maintenance release; surface support for monthly time series \cr
